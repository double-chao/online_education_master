package com.lcc.educenter.utils;
...
public class HttpClientUtils {
    ...
    public static String postParameters(String url, String parameterStr, String CHARSET, Integer CONN_TIMEOUT, Integer READ_TIMEOUT) throws ConnectTimeoutException, SocketTimeoutException, Exception {
        return post(url, parameterStr, "application/x-www-form-urlencoded", CHARSET, CONN_TIMEOUT, READ_TIMEOUT);
    }
    ...
    public static String postParameters(String url, Map<String, String> params, Integer CONN_TIMEOUT, Integer READ_TIMEOUT) throws ConnectTimeoutException,
            SocketTimeoutException, Exception {
        return postForm(url, params, null, CONN_TIMEOUT, READ_TIMEOUT);
    }
     ...
     * @throws Exception
     */
    public static String postForm(String url, Map<String, String> params, Map<String, String> headers, Integer CONN_TIMEOUT, Integer READ_TIMEOUT) throws ConnectTimeoutException,
            SocketTimeoutException, Exception {
