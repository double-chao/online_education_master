...
import com.lcc.aclservice.entity.Role;
import com.lcc.aclservice.entity.UserRole;
import com.lcc.aclservice.mapper.RoleMapper;
import com.lcc.aclservice.service.RoleService;
import com.lcc.aclservice.service.UserRoleService;
...
public class RoleServiceImpl extends ServiceImpl<RoleMapper, Role> implements RoleService {
    ...
    public Map<String, Object> findRoleByUserId(Integer userId) {
        ...
        List<Integer> existRoleList = existUserRoleList.stream().map(c -> c.getRoleId()).collect(Collectors.toList());
        //对角色进行分类
